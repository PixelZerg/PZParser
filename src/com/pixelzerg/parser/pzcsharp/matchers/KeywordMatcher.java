package com.pixelzerg.parser.pzcsharp.matchers;
 ...
 */
public class KeywordMatcher extends com.pixelzerg.parser.pzcsharp.MatcherBase {
    public String keyword = null;
    public boolean identifierRules = true;

    public KeywordMatcher(String keyword, Utils.TokenType type) {
        this.keyword = keyword;
        super.type = type;
    }

    public Token Select(Scanner s) throws NullPointerException {
        if(this.keyword == null)throw new NullPointerException("Keyword not set in KeywordMatcher");
